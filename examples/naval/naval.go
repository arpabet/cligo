...
func (cmd *ShipMove) Run(ctx context.Context) error {
	if cmd.Verbose {
...
func (cmd *Shoot) Run(ctx context.Context) error {
...
func (cmd *Set) Run(ctx context.Context) error {
...
func (cmd *Remove) Run(ctx context.Context) error {
